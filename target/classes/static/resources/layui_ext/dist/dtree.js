layui.define(["jquery", "layer", "form"], function (e) {
    var y = layui.$, f = layui.layer, r = layui.form, m = "dtree-nav-ul-sid", k = "dtree-nav-item", S = "dtree-nav-div",
        ...
        N = "dtree-nav-show", T = "dtree-nav-hide", x = "dtree-disabled", j = "dtree-icon-hide", a = y("body"),
    ...
    be.prototype.setting = function (e) {
        ...
        e.obj.before(n), e.obj.wrap('<div class="layui-card dtree-select" dtree-id="' + t + '" dtree-card="' + e.selectCardDiv + '"></div>').wrap('<div class="layui-card-body"></div>').wrap('<div id="' + e.selectTreeDiv + '"></div>'), e.selectVal(e.selectInitVal)
    }, be.prototype.selectVal = function (e) {
        var t = this, o = t.obj[0].id, a = t.selectInputName, i = "";
        void 0 === e && (e = t.getNowParam()), "string" == typeof e && (e = t.getParam(e)), i = e.context;
        var n = {};
        for (var s in a) n[a[s]] = e[s], y("div[dtree-select='" + t.selectDiv + "']").find("input[dtree-id='" + o + "'][name='" + a[s] + "']").val(e[s]);
            ...
            fe({
                ...
                success: function (e) {
                    ...
                    if ((t = "layuiStyle" == n.dataStyle ? e[n.response.statusName] : e.status[n.response.statusName]) == n.response.statusCode) {
                        ...
                        n.showLine(), n.toolbar && "contextmenu" != n.toolbarWay && n.setToolbarDom().setToolbarPlace(n.toolbarMenu), n.msgErrData(), s.addClass(N)
                    } else "layuiStyle" == n.dataStyle ? (n.obj.html(n.getNoneDom().errText(e[n.response.message])), n.error(null, t, e[n.response.message])) : (n.obj.html(n.getNoneDom().errText(e.status[n.response.message])), n.error(null, t, e.status[n.response.message]))
                },
                error: function (e, t, o) {
                    n.obj.html(n.getNoneDom().errText(t + ": " + o)), n.error(e, t, o)
        ...
        return {
            fnode: function () {
                ...
                return l ? "<ul class='" + m + "' data-id='" + r + "' dtree-id='" + p + "'></ul>" : h ? "<ul class='" + m + " " + N + "' data-id='" + r + "' dtree-id='" + p + "'></ul>" : "<ul class='" + m + "' data-id='" + r + "' dtree-id='" + p + "'></ul>"
            }
        }
        ...
        return {
            fnode: function (e) {
                ...
                var e = c ? "<ul class='" + m + "' data-id='" + d + "' dtree-id='" + p + "'></ul>" : h ? "<ul class='" + m + " " + N + "' data-id='" + d + "' dtree-id='" + p + "'></ul>" : "<ul class='" + m + "' data-id='" + d + "' dtree-id='" + p + "'></ul>";
        ...
        var g = "";
        return h && (g = T), ["<li class='" + C + " " + k + " " + g + " 'data-id='" + e + "'data-pid='" + ("root" == p ? void 0 !== typeof t && "" != t ? t : "-1" : t) + "'dtree-id='" + m + "'data-index='" + l + "'dtree-hide='" + h + "'>" + v, y.fnode(), y.node(), y.checkbox(), y.text(), "</div>", y.ul(), "</li>"].join("")
        ...
        if (this.accordion) {
            e.closest("li[data-index]").siblings("li[data-index]").children("ul[data-id]").removeClass(N);
        ...
        0 < n.length && ("close" == i ? ("load" == t.type ? t.cache ? n.html() ? n.addClass(N) : t.getChild(e) : (n.html(""), t.getChild(e)) : n.addClass(N), t.accordionUL(n), t.operateIcon(o, a).open()) : "open" == i && (n.removeClass(N), t.operateIcon(o, a).close()))
        ...
        if ("last" == a.eq(0).attr("data-spread") ? o.operateIcon(a.eq(0), a.eq(1)).openWithLeaf() : o.operateIcon(a.eq(0), a.eq(1)).open(), $ul.addClass(N), o.accordionUL($ul), t) if (t.length && 0 < t.length) o.getChild(e, t); else {
            var i = o.parseData(t);
            if (i.treeId()) {
            ...
            if (a.treeId()) {
                ...
                if (n && n != s) {
                    ...
                    if (0 == l.children("li").length) {
                        ...
                        o.operateIcon(d.eq(0), d.eq(1)).openWithLeaf(), l.addClass(N)
                    }
                    l.append($p_li)
                } else i.p_li();
                o.setNodeParam(e)
            ...
            openAllNode: function (e) {
                for (var t = e || c.obj.children("li").children("ul"), o = 0; o < t.length; o++) {
                    ...
                    if ("leaf" != r.attr("data-leaf")) {
                        "open" == l || ("load" == c.type ? c.cache ? a.html() ? a.addClass(N) : c.getChild(i) : (a.html(""), c.getChild(i)) : a.addClass(N), c.operateIcon(n, s).open());
                ...
                c.obj.find("." + m).each(function () {
                    ...
                    e.removeClass(N), c.operateIcon(o, a).close()
                })
        ...
        if (e) {
            ...
            "last" == c.eq(0).attr("data-spread") ? t.operateIcon(c.eq(0), c.eq(1)).openWithLeaf() : t.operateIcon(c.eq(0), c.eq(1)).open(), i.addClass(N), t.accordionUL(i), r ? t.getChild(n) : (t.showLine(i.find("li")), t.toolbar && "contextmenu" != t.toolbarWay && t.dynamicToolbarDom(l.find("cite[data-leaf]")))
        ...
        s.obj.on("click", "i[data-spread]", function (e) {
            ...
            if (s.toolbarHide(), s.navThis(t), s.select && (s.selectVal(o.nodeId), y("div[dtree-id='" + i + "'][dtree-select='" + s.selectTreeDiv + "']").toggleClass("layui-form-selected"), y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']").toggleClass("dtree-select-show layui-anim layui-anim-upbit")), s.useIframe) {
            ...
            e.stopPropagation();
            var t = y(this), o = (t.find("cite"), s.getNodeParam(t));
            s.toolbarHide(), s.navThis(t), s.select && (s.selectVal(o.nodeId), y("div[dtree-id='" + i + "'][dtree-select='" + s.selectTreeDiv + "']").toggleClass("layui-form-selected"), y("div[dtree-id='" + i + "'][dtree-card='" + s.selectCardDiv + "']").toggleClass("dtree-select-show layui-anim layui-anim-upbit")), layui.event.call(this, p, "nodedblclick(" + y(s.obj)[0].id + ")", {
                param: s.callbackData().node(o),
                childParams: s.callbackData().childNode(t),
                parentParam: s.callbackData().parentNode(t),
                dom: s.callbackData().dom(t)
        ...
        set: function (e) {
            ...
            var t = null, o = de.getElemId(e);
            return "" == o ? f.msg("页面中未找到绑定id", {icon: 5}) : ("object" == typeof (t = I[o]) && t.unbindBrowserEvent(), (t = new be(e)).selectSetting(e), (I[o] = t).initTreePlus(), t.openTreePlus(), t.init(), t.bindBrowserEvent()), t
        }, reload: function (e, t) {
