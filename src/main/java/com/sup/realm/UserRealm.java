    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if (null!=user){
            ...
            for (Permission permission : list) {
                percodes.add(permission.getName());
            }
            //放到activerUser
             ...
             * 参数4：当前类名
             */
            SimpleAuthenticationInfo info = new SimpleAuthenticationInfo(activerUser,user.getUserPassword(),credentialsSalt,this.getName());
            return info;
        }
        return null;
    }
